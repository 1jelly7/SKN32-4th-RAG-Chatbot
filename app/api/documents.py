...
async def download_document(doc_id: str, request: Request, user: CurrentUser) -> FileResponse:
    ...
    try:
        ...
        if mcp is None:
            raise MCPClientError("resolve_document_download", "문서 서비스가 구성되지 않았습니다.")
        ...
        raise HTTPException(status_code=403, detail="문서 다운로드 권한이 없습니다.") from exc
    except MCPClientError as exc:
        raise HTTPException(status_code=502, detail="문서 다운로드를 준비할 수 없습니다.") from exc
