"""소유자 결정 전 보존하는 legacy finance 배치 pipeline 스켈레톤."""
...
def run_csv_pipeline(
    ...
    """
    # TODO(contract clarification): 정식 purchase pipeline과의 관계를 확정한 뒤에만
    # extract→transform→validate→load를 구현한다. API/Agent 호출 금지와 검증 실패 시
    # load=None 계약을 fake test로 고정해야 한다.
    ...
